    ...
    companion object {
        ...
        fun notificationChannelId(notificationManager: NotificationManager): String {
            if (!notificationChannelInitiated){
                ...
                } else Log.i("TIMETABLE", "API Version is lower than 26. Not initiating notification channel.")
            }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (widgetIds.isNotEmpty()) {
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
                ...
                applicationContext.startService(Intent(applicationContext, TimetableService::class.java))
            }
